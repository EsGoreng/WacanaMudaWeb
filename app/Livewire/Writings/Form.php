        ...
        return $schema
            ->components([
                ...
                RichEditor::make('content')
                    ->label('Content')
                    ->hint('Recommend to use Fullscreen Mode')
                    ->columnSpanFull()
                    ->required()
                    ->floatingToolbars([
                        'paragraph' => [
                    ...
                    ->toolbarButtons([
                        ['fullscreen', 'bold', 'italic', 'underline', 'strike', 'subscript', 'superscript', 'small', 'code', 'highlight', 'clearFormatting', 'textColor', 'link'],
                        ['h1', 'h2', 'h3', 'lead'],
                        ['alignStart', 'alignCenter', 'alignEnd', 'alignJustify'],
                        ['blockquote', 'codeBlock', 'horizontalRule', 'details', 'grid'],
                ...
                // --- Hidden Fields Unsplash ---
                Hidden::make('image_credit')->live(),
                Hidden::make('image_credit_url')->live(),
                Hidden::make('unsplash_photo_id')->live(),
                Hidden::make('unsplash_download_location')->live(),
            ])
            ->statePath('data');
    }
